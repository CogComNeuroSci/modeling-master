...
@author: tom verguts
first attempt at continuous mountain car problem with policy gradient 
...
if __name__ == "__main__":
    ...
    if train_model:
        lc, solved = learn_w(env, n_loop = 500, input_dim = env.observation_space.shape[0], max_n_step = rl_agent.max_n_step)
    if save_model:
