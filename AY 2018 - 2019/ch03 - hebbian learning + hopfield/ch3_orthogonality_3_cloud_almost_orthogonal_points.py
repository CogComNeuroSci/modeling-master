...
n_samples = 100
x1_1 = (np.random.randn(n_samples)+ 10) * 6
x2_1 = (np.random.randn(n_samples)+ 10) * 5
x3_1 = (np.random.randn(n_samples)+ 10) * 2.5

x1_2 = (np.random.randn(n_samples)+ 10) * 2.5
x2_2 = (np.random.randn(n_samples)+ 10) * 5
x3_2 = (np.random.randn(n_samples)+ 10) * 6
