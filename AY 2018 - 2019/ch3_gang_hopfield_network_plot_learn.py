...
for the jets & sharks case; i.e., extra exercise 2
"""
...
fig, axs, texts_handles, lines_handles, unit_pos =\
    plot_network(figsize = [13, 7], activations = activations,
                  weights = weights_plot, layers = layers, energy = 0)
