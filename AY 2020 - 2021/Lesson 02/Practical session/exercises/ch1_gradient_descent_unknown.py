...
for step_i in np.arange(2, n_steps):
    ...
    # use the finite difference method to find in which direction to go at each
    # iteration using the alpha parameter (the steps size/scaling parameter)
    # ...
    
    
    # plot these latest values on the function plot using a custom color that
    # changes for each opitimization iteration
